...
function Menubar() {
  ...
  return (
    <div className="bg-black h-screen w-64 px-3 py-3">
      <div className="text-white text-2xl font-semibold">Pet-School Manager</div>
        ...
        <li>
          <a className="flex justify-between w-full h-full px-1.5 py-1.5" href='/'>
            <div className="flex">
              ...
              <div className="pl-1 text-sm font-semibold">홈</div>
            </div>
        ...
        <li>
          <button className={`${defaultStyle} ${activeDefaultStyle}`} onClick={toggleMenu}>
            <div className="flex">
              ...
              <div className="pl-1 text-sm font-semibold">학생관리</div>
            </div>
            <div>
          ...
          <ul className={isOpen ? "block flex flex-col gap-1 mt-1" : "hidden"}>
            <li>
              <a className="flex justify-between w-full h-full px-1.5 py-1.5" href='/'>
                <div className="pl-5">
                  <div className="pl-1 text-sm font-semibold">학생 조회</div>
                </div>
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
            ...
            <li>
              <a className="flex justify-between w-full h-full px-1.5 py-1.5" href='/'>
                <div className="pl-5">
                  <div className="pl-1 text-sm font-semibold">출결 체크</div>
                </div>
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
        ...
        <li>
          <a className="flex justify-between w-full h-full px-1.5 py-1.5" href='/'>
            <div className="flex">
              ...
              <div className="pl-1 text-sm font-semibold">공지사항</div>
            </div>
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
        ...
        <li>
          <a className="flex justify-between w-full h-full px-1.5 py-1.5" href='/'>
            <div className="flex">
              ...
              <div className="pl-1 text-sm font-semibold">메뉴01</div>
            </div>
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
